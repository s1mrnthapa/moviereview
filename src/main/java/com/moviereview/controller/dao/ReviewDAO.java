...
public class ReviewDAO {
 ...
 // In ReviewDAO.java
	 ...
	 * Review review = new Review(); review.setReviewID(rs.getInt("reviewID"));
	 * review.setMovieID(rs.getInt("movieID"));
	 * review.setUserID(rs.getInt("userID")); review.setRating(rs.getInt("rating"));
	 * review.setReviewDate(rs.getTimestamp("review_date"));
	 * review.setReviewDescription(rs.getString("reviewDescription"));
	 * review.setMovieTitle(rs.getString("movieTitle")); return review; }
	 */
