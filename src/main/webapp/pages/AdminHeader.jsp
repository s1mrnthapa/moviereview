...
<body>
	<header>
		...
		<div class="left_header sub_header">
			<a href="<%= request.getContextPath() %>/DashboardServlet" class ="page"> DASHBOARD</a>			
            <a href="${pageContext.request.contextPath}/pages/addMovie.jsp" class = "page">Add Movies</a>
            <a href="<%= request.getContextPath() %>/AdminMoviesServlet" class = "page">MOVIES</a>
            <a href="<%= request.getContextPath() %>/AllUsersServlet" class = "page">Users</a>
        </div>
        ...
        <div class="sub_header right_header">
            ...
            <div class="user_icon_wrapper">
                ...
                <div class="drop-box">
                    <a href="<%= request.getContextPath() %>/AdminProfileServlet" class="drop-box-nav1"><p>Profile</p></a>
